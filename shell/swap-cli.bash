_swap-cli() {
    ...
    case "${cmd}" in
        swap__cli)
            opts="-h -V -d -v -T -m -x --help --version --data-dir --verbose --tor-proxy --msg-socket --ctl-socket info peers list-swaps list-offers list-listens make take progress cancel-swap needs-funding help"
